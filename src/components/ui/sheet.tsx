...
const Sheet: React.FC<SheetPrimitive.Root.Props> = ({
  ...props
}: SheetPrimitive.Root.Props) => {
  return <SheetPrimitive.Root data-slot="sheet" {...props} />
}
const SheetTrigger: React.FC<SheetPrimitive.Trigger.Props> = ({
  ...props
}: SheetPrimitive.Trigger.Props) => {
  return <SheetPrimitive.Trigger data-slot="sheet-trigger" {...props} />
}
const SheetClose: React.FC<SheetPrimitive.Close.Props> = ({
  ...props
}: SheetPrimitive.Close.Props) => {
  return <SheetPrimitive.Close data-slot="sheet-close" {...props} />
}
const SheetPortal: React.FC<SheetPrimitive.Portal.Props> = ({
  ...props
}: SheetPrimitive.Portal.Props) => {
  return <SheetPrimitive.Portal data-slot="sheet-portal" {...props} />
}
const SheetOverlay: React.FC<SheetPrimitive.Backdrop.Props> = ({
  className,
  ...props
...
const SheetTitle: React.FC<SheetPrimitive.Title.Props> = ({
  className,
  ...props
...
const SheetDescription: React.FC<SheetPrimitive.Description.Props> = ({
  className,
  ...props
