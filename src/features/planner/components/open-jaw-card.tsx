...
export const OpenJawCard: FC<OpenJawCardProps> = ({ openJaw }) => {
  ...
  return (
    <article className="bg-primary/[0.035] px-3 py-2 text-muted-foreground">
      <div className="grid grid-cols-[1.5rem_minmax(0,1fr)] items-center gap-x-2.5">
        <span className="grid size-6 shrink-0 place-items-center rounded-full border border-dashed border-primary/40 bg-background text-primary">
